...
Important:  Si vous executez ces commandes les microservices ne seront pas en meme réseaux de kafka et zookeeper alors vaux mieux copier les depuis le fichier docker-compose.yml
